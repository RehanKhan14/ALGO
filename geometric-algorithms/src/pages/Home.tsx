        ...
        <div className={style.container}>
            ...
            <Features1 
                ...
                subsections={[  {heading:"Counter Clock Wise Algorithm",para:"The Counter-Clockwise (CCW) algorithm determines whether three points are arranged in a counter-clockwise order, useful in line intersection calculations. Its time complexity is O(1), making it computationally efficient for assessing the relative orientations of points in planar geometry."},
                                {heading:"Algebraic Algorithm",para:"The Algebraic Line Intersection Algorithm employs algebraic methods to determine the intersection points of two lines in the plane. Its time complexity depends on the specific implementation and the underlying algebraic techniques used, often falling within O(1) for straightforward cases or O(log n) for more complex scenarios involving advanced algebraic computations."},
